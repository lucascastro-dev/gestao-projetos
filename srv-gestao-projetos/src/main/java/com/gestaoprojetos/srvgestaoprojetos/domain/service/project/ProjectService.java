package com.gestaoprojetos.srvgestaoprojetos.domain.service.project;
...
import com.gestaoprojetos.srvgestaoprojetos.domain.repository.ProjectRepository;
...
public class ProjectService implements IProjectService<IProjectForm> {
    ...
    @Override
    public IProjectEntity findProjectByClient(Long idCliente) {
        return null;
    }
}
