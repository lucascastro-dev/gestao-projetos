package com.gestaoprojetos.srvgestaoprojetos.infra.service.activity;
...
import com.gestaoprojetos.srvgestaoprojetos.infra.repository.ActivityRepository;
...
public class ActivityService implements IActivityService<IActivityForm> {
    ...
    @Override
    public IActivityEntity findByProjects(IProjectEntity idProject) {
        return activityRepository.findByProjects(idProject);
    }
}
